...
class TermsConditionsScreen extends StatelessWidget {
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 16.h),
                    _buildArabicSectionTitle('التعريفات'),
                    _buildArabicText(
                    ...
                    _buildArabicSectionTitle(
                        'الشروط العامة (تسري على جميع الأطراف)'),
                    ...
                    _buildArabicSectionTitle('التزامات المستخدم (المسافر)'),
                    _buildArabicNumberedList([
                    ...
                    _buildArabicSectionTitle('التزامات الشريك (مقدم الخدمة)'),
                    _buildArabicNumberedList([
                    ...
                    _buildArabicSectionTitle('إخلاء المسؤولية للأنشطة الخطرة'),
                    _buildArabicText(
  ...
  Widget _buildArabicSectionTitle(String title) {
    return Padding(
      padding: EdgeInsets.only(top: 16.h, bottom: 8.h),
      child: Container(
        alignment: Alignment.centerRight,
