                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: _getStatusColor(activityData['status']),
                    ...
                    Row(
                      children: [
                        RatingBarIndicator(
                          rating: (activityData['rate'] ?? 0).toDouble(),
                    ...
                    _buildInfoSection(
                      'Location',
                      activityData['activityLocation'] ?? 'Not specified',
                      Icons.location_on,
                    ),
                    ...
                    if (activityData['rulesAndCancellationPolicy'] != null)
                      _buildExpandableSection(
