    ...
    return Scaffold(
        ...
        body: CustomScrollView(slivers: [
          ...
          SliverAppBar(
              ...
              flexibleSpace:
                  FlexibleSpaceBar(background: _buildHeroImage(tripData))),
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Container(
                                ...
                                child: Text(tripData.status ?? 'Active',
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontSize: 13.sp,
                            ...
                            // End Point
                            _buildInfoSection('End Point',
                                "${tripData.endPoint ?? 'N/A'}", Icons.flag),
  ...
  Widget _buildSectionTitle(String title) {
    return Row(children: [
      Container(
          ...
          height: 24.h,
          decoration: BoxDecoration(
              color: appTextColor, borderRadius: BorderRadius.circular(2.r))),
      SizedBox(width: 12.w),
      Text(title,
          style: TextStyle(
              fontSize: 20.sp,
