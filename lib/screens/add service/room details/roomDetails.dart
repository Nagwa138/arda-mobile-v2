    ...
    return Form(
      ...
      child: ListView(
        children: [
          ...
          context.read<AddServiceCubit>().singleRoomNum <= 0
              ? SizedBox.shrink()
              : SingleRoomBuilder(),
          context.read<AddServiceCubit>().doubleRoomNum <= 0
              ? SizedBox.shrink()
              : DoubleRoomBuilder(),
          context.read<AddServiceCubit>().tripleRoomNum <= 0
              ? SizedBox.shrink()
              : TripleRoomBuilder(),
          context.read<AddServiceCubit>().kingRoomNum <= 0
              ? SizedBox.shrink()
              : KingRoomBuilder(),
        ],
      ),
