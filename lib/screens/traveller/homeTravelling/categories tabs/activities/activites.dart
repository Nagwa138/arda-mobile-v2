                              ...
                              child: GestureDetector(
                                onTap: () {
                                  Navigator.pushNamed(
                                      ...
                                      arguments: {
                                        'activityId': ActivityCubit.get(context)
                                            .getAllActivityModel!
                                            .data![index]
                                            .id
                                            .toString(),
                                        'activityName':
                                            ActivityCubit.get(context)
                                                ...
                                                .activitieName
                                                .toString(),
                                        'rate': ActivityCubit.get(context)
                                            .getAllActivityModel!
                                            .data![index]
                                            .rate
                                            .toString(),
                                        'price': ActivityCubit.get(context)
                                            .getAllActivityModel!
                                            .data![index]
                                            .pricePerPerson
                                            .toString(),
                                        'des': ActivityCubit.get(context)
                                            .getAllActivityModel!
                                            .data![index]
                                            .description
                                            .toString(),
                                      ...
                                      child: Stack(
                                        ...
                                        children: [
                                          ClipRRect(
                                            ...
                                            // child: Image.network(
                                            //   ActivityCubit.get(context).getAllActivityModel!.data![index].image.toString(),
                                            //   height: 200.h,
                                            //   width: 1.sw,
                                            //   fit: BoxFit.fitWidth,
                                            // ),
                                              ...
                                              Text.rich(
                                                TextSpan(
                                                  children: [
                                                    TextSpan(
                                                      text:
                                                          '${ActivityCubit.get(context).getAllActivityModel!.data![index].pricePerPerson.toString()} ${context.locale.languageCode == 'ar' ? "جنية" : "EGP"}',
                                                      style: TextStyle(
                                                        color: accentColor,
                                                        fontSize: 14.sp,
                                                        fontWeight:
