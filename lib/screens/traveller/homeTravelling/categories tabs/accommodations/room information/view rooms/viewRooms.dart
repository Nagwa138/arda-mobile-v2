              ...
              return BlocConsumer<AddServiceCubit, AddServiceState>(
                  ...
                  builder: (context, state) {
                    return Scaffold(
                            ...
                            child: Padding(
                                ...
                                child: Column(children: [
                                  ...
                                  _buildSectionCard(context,
                                      ...
                                      title: "Available Rooms", child:
                                          BlocBuilder<CardCubitRoom,
                                                  List<RoomList>>(
                                              builder: (context, state) {
                                    return Column(
                                  ...
                                  _buildSectionCard(context,
                                      ...
                                      child: Row(children: [
                                        Expanded(
                                            child: _modernRadioTile(context,
                                                value: 0,
                                                groupValue:
                                                    BookingTravellerCubit.get(
                                                            context)
                        ...
                        bottomNavigationBar:
                            BlocBuilder<CardCubitRoom, List<RoomList>>(
                          ...
                          return Padding(
                              ...
                              child: Container(
                                  ...
                                  child: BlocBuilder<BookingTravellerCubit,
                                    ...
                                    final isLoading = bookingState
                                        is CreateBookingRoomLoading;
                                    return ElevatedButton(
                                        style: ButtonStyle(
                                            backgroundColor:
                                                WidgetStateProperty.all(isLoading
                                                    ? Colors.grey
                                                    : accentColor),
          ...
          Expanded(
              child: Column(
                ...
                Container(
                    ...
                    child: Text('${room.price ?? 0} EGP / night',
                        style: TextStyle(
                            fontSize: 14.sp,
                            fontWeight: FontWeight.w700,
                            color: accentColor))),
                ...
                Container(
                    ...
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      IconButton(
                          ...
                          color:
                              initialQuantity > 0 ? accentColor : Colors.grey,
                          iconSize: 22.sp,
                      ...
                      IconButton(
                          ...
                          color:
                              initialQuantity < 20 ? accentColor : Colors.grey,
                          iconSize: 22.sp,
                          padding: EdgeInsets.all(4.w),
                          constraints: BoxConstraints()),
                    ])),
          ...
          child: TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.calendar_today_rounded,
                      color: accentColor.withValues(alpha: 0.5), size: 20.sp),
