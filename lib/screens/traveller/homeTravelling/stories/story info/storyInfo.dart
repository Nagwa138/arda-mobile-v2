  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
        create: (BuildContext context) =>
            HomeTravellerCubit()..getBlogById(args?['id']),
                  ...
                  body: ListView(children: [
                          ...
                          Padding(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    InkWell(
                                        onTap: () {
                                          if (HomeTravellerCubit.get(context)
                                                  .blogByIdModel
                                                  ?.data
                                                  ?.isFavourite ==
                                              true) {
                    ...
                    Padding(
                        ...
                        child: Column(children: [
                          Row(children: [
                            Image.asset("assets/images/landingHome/profile.png",
                                width: 20.w, height: 20.h, color: orange),
                            SizedBox(width: 4.w),
                            Text(
                                HomeTravellerCubit.get(context)
                                    .blogByIdModel!
