          ...
          Stack(children: [
            ClipRRect(
                ...
                child: CustomImage(image,
                    fit: BoxFit.cover, height: 220.h, width: double.infinity)),
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    Icon(Icons.star_rounded,
                                        color: Color(0xFFFFCE47), size: 18.sp),
                                    SizedBox(width: 4.w),
                                    Text(rate.toString(),
                                        style: TextStyle(
                                            color: textColor,
                        ...
                        child: Row(
                            ...
                            children: [
                              ...
                              RichText(
                                ...
                                TextSpan(
                                    text:
                                        ' ${context.locale.languageCode == 'ar' ? "Ø¬Ù†ÙŠØ©" : "EGP"}',
                                    style: TextStyle(
                                        color: accentColor,
                                        fontSize: 14.sp,
