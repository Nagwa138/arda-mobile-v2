                                                                  ...
                                                                  children: [
                                                                    SizedBox(
                                                                        width: 200
                                                                            .w,
                                                                        child: Text(
                                                                            FavouriteCubit.get(context).activity!.data![index].activitieName.toString(),
                                                                    ...
                                                                    Row(
                                                                        children: [
                                                                          ...
                                                                          SizedBox(
                                                                              width: 60.w,
                                                                              child: Text("booking.Luxor".tr() + "   ", style: TextStyle(fontSize: 14.sp, color: Color.fromRGBO(140, 140, 140, 1), fontWeight: FontWeight.w400))),
                                                                          SizedBox(
                                                                              width: 60.w,
                                                                              child: Text("booking.Egypt".tr(), style: TextStyle(fontSize: 14.sp, color: Color.fromRGBO(140, 140, 140, 1), fontWeight: FontWeight.w400))),
                                                                          SizedBox(
                                                                              width: 30.w),
                                                                          Icon(
                                                                              ...
                                                                              color: Colors.amber),
                                                                          Text(
                                                                              FavouriteCubit.get(context).activity!.data![index].rate.toString(),
                                                                    ...
                                                                    Row(
                                                                        children: [
                                                                          SizedBox(
                                                                              width: 115.w,
                                                                              child: Text(FavouriteCubit.get(context).activity!.data![index].pricePerPerson.toString() + "booking.EGP".tr(), style: TextStyle(fontSize: 14.sp, color: accentColor, fontWeight: FontWeight.w400))),
                                                                          SizedBox(
                                                                              width: 55),
                                                                          IconButton(
                                                                              onPressed: () {
                                                                                ActivityCubit.get(context).deleteFavouriteOfActivity(activityId: FavouriteCubit.get(context).activity!.data![index].id.toString());
                                                                              },
