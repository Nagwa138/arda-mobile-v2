                                                          ...
                                                          Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                Row(children: [
                                                                  Row(
                                                                      children: [
                                                                        Text(FavouriteCubit.get(context).product!.data![index].price.toString() + "booking.EGP".tr(),
                                                                            style: TextStyle(
                                                                                fontSize: 14.sp,
                                                                                color: accentColor,
                                                                  ...
                                                                  IconButton(
                                                                      onPressed:
                                                                        ...
                                                                        ProductCubit.get(context).deleteFavouriteOfProduct(
                                                                            productId:
                                                                                FavouriteCubit.get(context).product!.data![index].id.toString());
                                                                      },
                                                                      icon: Icon(
                                                                          Icons
                                                                              .favorite,
