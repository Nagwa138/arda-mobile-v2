                    ...
                    child: Padding(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 8.h),
                              Text("You haven't completed any bookings yet",
                      ...
                      GestureDetector(
                          onTap: () {
                            print(BookingTravellerCubit.get(context)
                                ...
                                .toString());
                            Navigator.pushNamed(
                                context, "detailsBookingCompleted",
                                arguments: {
                                  'completedId':
                                      ...
                                      Row(children: [
                                        Expanded(
                                            child: ElevatedButton(
                                                ...
                                                child: Text("booking.Review".tr(), style: TextStyle(fontSize: 11.sp, color: accentColor, fontWeight: FontWeight.w600)))),
                                      ]),
