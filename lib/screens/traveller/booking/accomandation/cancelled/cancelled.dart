    ...
    return BlocProvider(
        ...
        child: BlocConsumer<BookingTravellerCubit, BookingTravellerStates>(
          ...
          if (state is BookingAgainRoomsSuccessful) {
            ...
            context.showCustomSnackBar("Successful",
                type: SnackBarType.success);
          } else if (state is BookingAgainRoomsError) {
            context.showCustomSnackBar(state.error, type: SnackBarType.error);
          }
          ...
          final bookingsCount =
              BookingTravellerCubit.get(context).cancel?.data?.length ?? 0;
          if (bookingsCount == 0) {
            return Center(
                child: Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 8.h),
                          Text("You don't have any cancelled bookings",
                  ...
                  GestureDetector(
                      onTap: () {
                        ...
                        Navigator.pushNamed(context, "detailsBookingCanceled",
                            arguments: {
                              'cancelId': BookingTravellerCubit.get(context)
                                  .cancel!
                                  .data![index]
                                  .id
                                  .toString()
