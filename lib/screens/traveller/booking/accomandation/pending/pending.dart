                  ...
                  itemBuilder: (context, index) {
                    return Column(children: [
                      GestureDetector(
                          onTap: () {
                            Navigator.pushNamed(
                                context, "detailsBookingPending", arguments: {
                                      ...
                                      Row(children: [
                                        Expanded(
                                            ...
                                            child: ElevatedButton(
                                                ...
                                                child: Text("booking.CancelBooking".tr(), style: TextStyle(fontSize: 10.sp, color: accentColor, fontWeight: FontWeight.w600)))),
                                      ]),
