                                      ...
                                      child: Padding(
                                          ...
                                          child: SizedBox(
                                              ...
                                              child: ElevatedButton(
                                                  ...
                                                  child: Text("booking.cancel".tr(), style: TextStyle(fontSize: 10.sp, color: accentColor, fontWeight: FontWeight.w600)))))),
                                  Expanded(
                                      flex: 2,
                                      child: Padding(
                                          padding: EdgeInsets.symmetric(
                                          ...
                                          child: SizedBox(
                                              ...
                                              child: ElevatedButton(
                                                  ...
                                                  child: Text("booking.CompleteBooking".tr(), style: TextStyle(fontSize: 10.sp, color: white, fontWeight: FontWeight.w600)))))),
                                ]),
                              ]))),
                      SizedBox(height: 10.h),
                    ]);
