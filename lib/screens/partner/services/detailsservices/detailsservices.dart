                      ...
                      children: [
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(width: 6.w),
                                    Text(
                                      item.serviceDetails?.accomodationType ??
                                          "N/A",
                                      style: TextStyle(
                                        color: orange,
                                        fontSize: 13.sp,
                          ...
                          child: Column(
                            children: [
                              _buildInfoRow(
                                ...
                                value: item.companyDetails?.address ?? "N/A",
                              ),
                              ...
                              _buildLinkRow(
                                ...
                                link: item.companyDetails?.addressLink ?? "N/A",
                              ),
                            ],
                          ),
                        ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Wrap(
                                ...
                                runSpacing: 8.h,
                                children:
                                    (item.serviceDetails?.amenityName ?? [])
                                        .map((e) => _buildChip(e))
                                        .toList(),
                              ),
                              SizedBox(height: 20.h),
                              ...
                              SizedBox(height: 12.h),
                              ...(item.serviceDetails?.roomsType ?? []).map(
                                (e) => Padding(
                              ...
                              _buildInfoRow(
                                ...
                                value: (item.serviceDetails?.roomsType ?? [])
                                    .fold(0,
                        ...
                        _buildSectionCard(
                          ...
                          child: _buildImportantInfoItem(
                            ...
                            text: item.serviceDetails?.importantInformation ??
                        ...
                        _buildSectionCard(
                          ...
                          child: GridView.builder(
                            ...
                            itemCount:
                                item.serviceDetails?.roomsType?.length ?? 0,
                            gridDelegate:
                            ...
                            itemBuilder: (context, index) {
                              final room =
                                  item.serviceDetails!.roomsType![index];
                              return _buildRoomCard(context, room, item);
                            },
                          ),
                        ),
                          ...
                          child: Column(
                            children: [
                              _buildLinkRow(
                                icon: Icons.language,
                                title: "Website",
                                link: item.companyDetails?.website ?? "N/A",
                              ),
                              SizedBox(height: 12.h),
                              _buildInfoRow(
                                icon: Icons.phone_outlined,
                                title: "Official phone",
                                value: item.companyDetails?.phone ?? "N/A",
                              ),
                              SizedBox(height: 12.h),
                              _buildInfoRow(
                                icon: Icons.language_outlined,
                                title: "Language your employees will speak",
                                value: item.serviceDetails?.language ?? "N/A",
                              ),
                            ],
                          ),
                        ),
