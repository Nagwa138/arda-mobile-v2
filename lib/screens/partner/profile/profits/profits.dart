      ...
      child: BlocConsumer<UserCubit,UserState>(
        ...
        builder: (context,state){
          return Scaffold(
            ...
            body:
            state is ProfitsLoading ? Center(child: CircularProgressIndicator(color: orange,)) :
            Column(
              children: [
                SizedBox(
                  height: 290.h + 150.h,
                ...
                Text(
                  "${UserCubit.get(context).profitsModel?.data?.totalBooking.toString()} " + 'profits.reservation'.tr(),
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    color: black,
                    fontSize: 28.sp,
