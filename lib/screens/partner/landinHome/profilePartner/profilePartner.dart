  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (BuildContext context) =>
          LandingMainContentCubit()..getGuestById(id: arguments['id']),
                ...
                : SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        Center(
                            child: Image.asset(
                                "assets/images/landingHome/famele.png")),
                        Center(
                          child: Text(
                        ...
                        Padding(
                          padding: EdgeInsets.symmetric(horizontal: 20.w),
                          child: Text(
                            "ProfileGuest.informationGuest".tr(),
                            style: TextStyle(
                                fontSize: 18.sp,
                                color: accentColor,
                                fontWeight: FontWeight.w600))),
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  ProfileInformation(
                                    title: "ProfileGuest.name",
                                    title2: LandingMainContentCubit.get(context)
                                        .guestByIdModel!
                                        .data!
                                        .guestInfo!
                                        .name
                        ...
                        Padding(
                          padding: EdgeInsets.symmetric(horizontal: 20.w),
                          child: Text(
                            "ProfileGuest.BookingInformation".tr(),
                            style: TextStyle(
                                fontSize: 18.sp,
                                color: accentColor,
                                fontWeight: FontWeight.w600))),
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      Navigator.pushNamed(
                                          ...
                                          arguments: {
                                            "id": LandingMainContentCubit.get(
                                                    context)
                                                .guestByIdModel!
                                                .data!
                                                .id
                                                .toString(),
                                            "night": LandingMainContentCubit
                                                    .get(context)
                                                .calculateDifference(
                                                    startDateStr:
                                                        LandingMainContentCubit
                                                                .get(context)
                                                            .guestByIdModel!
                                                            .data!
                                                            .bookingInfo!
                        ...
                        Padding(
                          padding: EdgeInsets.symmetric(horizontal: 20.w),
                          child: Text(
                            "ProfileGuest.PaymentInformation".tr(),
                            style: TextStyle(
                                fontSize: 18.sp,
                                color: accentColor,
                                fontWeight: FontWeight.w600))),
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          SizedBox(
                                            width: 150.w,
                                            child: Text(
                                              "${LandingMainContentCubit.get(context).guestByIdModel!.data?.serviceDetails!.title.toString()}",
                                              style: TextStyle(
                                                  fontSize: 16.sp,
                                                  color: accentColor,
                                                  fontWeight: FontWeight.w600))),
                                          Row(
                                            children: [
                                              ...
                                              Text(
                                                "${LandingMainContentCubit.get(context).guestByIdModel!.data?.serviceDetails!.location.toString()}",
                                                style: TextStyle(
                                                    fontSize: 14.sp,
                                                    color: accentColor,
                                                    fontWeight:
                                          ...
                                          Row(
                                            children: [
                                              Text(
                                                "${LandingMainContentCubit.get(context).guestByIdModel!.data?.serviceDetails!.price.toString()}" +
                                                    "   " +
                                                    "booking.EGP".tr(),
                                                style: TextStyle(
                                                    fontSize: 14.sp,
