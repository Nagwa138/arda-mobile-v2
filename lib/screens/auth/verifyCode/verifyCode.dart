        ...
        listener: (context, state) {
          ...
          if (state is VerifyCodeError) {
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              content: Text(state.error,style: TextStyle(color:  white),),
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'login.verifyCode'.tr(),
                                style: TextStyle(fontSize: 24, fontWeight: FontWeight.w700, color: accentColor),
                              ),
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      ...
                                      style: const TextStyle(
                                        ...
                                        color: Color.fromRGBO(122, 134, 153, 1),
                                      ),
                                    ),
                                  ),
                                  SizedBox(
                              ...
                              Padding(
                                ...
                                child: PinCodeTextField(
                                  ...
                                  controller: LoginCubit.get(context).verifyCode,
                                  ...
                                  textStyle: TextStyle(fontSize: 20.sp, fontWeight: FontWeight.w600, color: accentColor),
                                  // onTap: () {
                                  //   print("Pressed");
                                  // },
                                  onChanged: (value) {
                                    debugPrint(value);
                                    context.read<LoginCubit>().verifyCode.text = value;
                                  },
                              ...
                              CustomButton(
                                  height: 50.h,
                                  backgroudColor: LoginCubit.get(context).verifyCode.text.trim().isEmpty ? Color.fromRGBO(140, 140, 140, 1) : orange,
                                  function: () {
                                    if (LoginCubit.get(context).formKeyVerifyCode.currentState!.validate()) {
                                      // Navigator.pushNamed(context, 'createPassword');
                                      print('verifyCode: ${LoginCubit.get(context).verifyCode.text}');
                                    }
                                    context.read<LoginCubit>().verifyCodeSentToUser(email: args["email"]!);
                                  },
                              ...
                              Row(
                                ...
                                children: [
                                  Text(
                                    'login.sendCode'.tr(),
                                    style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: accentColor),
                                  ),
                                  GestureDetector(
                                    onTap: () {
                                      // context.read<LoginCubit>().sendCode(email: args["email"]!);
                                      LoginCubit.get(context).verifyCode.text = '';
                                      LoginCubit.get(context).sendCode(email: args["email"]!).then(
