class GetAccomaondationBasedTypeModel {
  int? statusCode;
  String? message;
  List<Data>? data;

  GetAccomaondationBasedTypeModel({this.statusCode, this.message, this.data});

  GetAccomaondationBasedTypeModel.fromJson(Map<String, dynamic> json) {
